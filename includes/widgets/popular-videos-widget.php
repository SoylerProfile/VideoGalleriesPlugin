...
<!--                                    <div class="fleft author">by <a href="#">Masum Rana</a></div>-->
                            ...
                            <div class="row m0 taxonomy">
                                <div class="fleft category"><a href="#"><img src="images/cat.png" alt=""><?=$category_name;?></a></div>
                                <div class="fright views"><a href="#"><img src="images/views.png" alt=""><?=$video->video_views;?></a></div>
                            </div>
                        </div>
                    </article>
                <?php endforeach; ?>
