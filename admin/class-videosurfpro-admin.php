...
class Videosurfpro_Admin {
    ...
    public static function add_plugin_admin_menu() {
        ...
        add_submenu_page( 'videosurfpro_admin_menu', 'All Videos', 'All Videos', 'manage_options', 'videosurfpro_submenu_all_videos', 'videosurfpro_display_submenu_all_videos' );
        add_submenu_page( 'videosurfpro_admin_menu', 'All Categories', 'All Categories', 'manage_options', 'videosurfpro_submenu_all_categories', 'videosurfpro_display_submenu_all_categories' );
        add_submenu_page( 'videosurfpro_admin_menu', 'All Galleries', 'All Galleries', 'manage_options', 'videosurfpro_submenu_all_galleries', 'videosurfpro_display_submenu_all_galleries' );
